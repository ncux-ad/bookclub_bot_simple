...
26. [x] **Автоматические блокировки** - Защита от спама (без обратной связи)
...
- [x] Защита от спама заблокированных пользователей (без обратной связи)
- [x] **Модуль добавления книг** - команда `/addbook` с FSM
- [x] **Исправление валидатора** - поддержка токенов 30-35 символов
- [x] **Исправление FSM состояний** - все состояния работают корректно
